...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PD1     ------> UART4_TX
    */
    HAL_GPIO_DeInit(GPIOD, RX4_GNSS_Pin|TX4_GNSS_Pin);
  ...
  /* USER CODE END UART7_MspDeInit 0 */
    ...
    PE10     ------> UART7_CTS
    */
    HAL_GPIO_DeInit(GPIOE, RX7_4G_Pin|TX7_4G_Pin|RTS7_4G_Pin|CTS7_4G_Pin);
  ...
  /* USER CODE END UART8_MspDeInit 0 */
    ...
    PE1     ------> UART8_TX
    */
    HAL_GPIO_DeInit(GPIOE, RX8_EXT_Pin|TX8_EXT_Pin);
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PA10     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOA, TX1_FRONT_Pin|RX1_FRONT_Pin);
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PA3     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOA, TX2_RADIO_Pin|RX2_RADIO_Pin);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PD9     ------> USART3_RX
    */
    HAL_GPIO_DeInit(DE3_RS485_GPIO_Port, DE3_RS485_Pin);

    HAL_GPIO_DeInit(GPIOD, TX3_RS485_Pin|RX3_RS485_Pin);
  ...
  /* USER CODE END USART6_MspDeInit 0 */
    ...
    PC7     ------> USART6_RX
    */
    HAL_GPIO_DeInit(GPIOC, TX6_BACK_Pin|RX6_BACK_Pin);
